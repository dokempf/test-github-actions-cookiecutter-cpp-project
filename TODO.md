...
* Set up a remote repository. You can e.g. create a project in GitHub or GitLab and run
  ...
  For a seamless integration, the name of the project should also be `test-github-actions-cookiecutter-cpp-project`.
...
* Enable the integration with `codecov.io` by heading to the [Codecov.io Website](https://codecov.io),
  log in (e.g. with your Github credentials) and enable integration for your repository.