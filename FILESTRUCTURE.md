...
* C++ source files:
  * `include/test-github-actions-cookiecutter-cpp-project/test-github-actions-cookiecutter-cpp-project.hpp` is the main
    C++ header that declares the interface of your library.
  * `src/test-github-actions-cookiecutter-cpp-project.cpp` is the main file that implements this library.
  * `app/test-github-actions-cookiecutter-cpp-project_app.cpp` is an executable that uses the library.
    This can e.g. be used to provide a command line interface for your project.
  * `tests/test-github-actions-cookiecutter-cpp-project_t.cpp` contains the unit tests for the library.
  ...
  * `python/test-github-actions-cookiecutter-cpp-project_python.cpp` is the source file
